...
do
    ...
    --gain 0.01 --lr 7e-4 --critic_lr 1e-3 --hidden_size 512 --layer_N 2 --entropy_coef 0.015 --user_name=qhughes22 --run_name final_check --use_eval --use_wandb \
    --model_dir "/home/haoming/extreme_driving/Adeesh/MLGT/marl-the-crew/onpolicy/scripts/results/The_Crew/TheCrew-small-rockets/mappo/check/wandb/run-20231211_231218-xyi9p8t7/files" \
