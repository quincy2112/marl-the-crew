...
do
    ...
    --num_mini_batch 1 --episode_length 100 --num_env_steps 10000000000000 --ppo_epoch 15 --gamma 1 --perfect_info \
    --gain 0.01 --lr 7e-4 --critic_lr 1e-3 --hidden_size 512 --layer_N 2 --entropy_coef 0.015 --user_name=qhughes22 --run_name perf_bidir --use_bidirectional_rep
